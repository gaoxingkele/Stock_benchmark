...
| `experiments/case_lingxi_capacity_slippage/case_lingxi_capacity_slippage_summary.csv` | 60 | Nonlinear capacity/slippage stress at 10 bps base cost, 0.5-10x AUM, and 0-20 impact bps |
...
11. The nonlinear capacity/slippage stress audit also finds no candidate reaches the production gate; context router remains risk-control only.
