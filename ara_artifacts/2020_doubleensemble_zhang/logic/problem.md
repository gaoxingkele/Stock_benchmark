...
- **Statement**: `2020_doubleensemble_zhang` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2020_doubleensemble_zhang.txt`
...
- **Statement**: `2020_doubleensemble_zhang` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
