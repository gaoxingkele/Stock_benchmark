...
- **Statement**: `2020_doubleensemble_zhang` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2020_doubleensemble_zhang` is grounded in current repository metadata and available source files.
- **Status**: supported
