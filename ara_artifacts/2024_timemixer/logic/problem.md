...
- **Implication**: TimeMixer: Decomposable Multiscale Mixing for Time Series Forecasting should be translated into a falsifiable proxy module before any production claim.

### O2: The paper belongs to the `multiscale_mlp` family
- **Statement**: Local survey metadata classifies this candidate as `multiscale_mlp`.
- **Evidence**: `papers/metadata/lingxi_cross_domain_ts_sota_candidates.csv`
- **Implication**: The first local validation should test the corresponding Lingxi transfer idea: `Multiscale momentum/reversal/trend decomposition features`.
