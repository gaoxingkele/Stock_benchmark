...
- **Statement**: `TimeMixer: Decomposable Multiscale Mixing for Time Series Forecasting` is a relevant source for the local upgrade idea `Multiscale momentum/reversal/trend decomposition features`.
- **Status**: hypothesis
