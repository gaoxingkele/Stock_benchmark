...
- **Type**: baseline
- **Delta**:
  - What changed: `TimeMixer: Decomposable Multiscale Mixing for Time Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `multiscale_mlp`.
- **Claims affected**: C02
