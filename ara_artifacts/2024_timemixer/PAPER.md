...
year: 2024
venue: "ICLR 2024"
doi: "https://arxiv.org/abs/2405.14616"
ara_version: "1.0"
domain: "cross-domain time-series methodology"
keywords: ["time-series", "multiscale-mlp", "forecasting", "Lingxi-upgrade", "TopK-ranking", "ARA"]
claims_summary:
  - "TimeMixer: Decomposable Multiscale Mixing for Time Series Forecasting contributes a multiscale_mlp method family relevant to time-series modeling."
  - "The method is a candidate source for Multiscale momentum/reversal/trend decomposition features."
abstract: "Methodology-focused ARA package for TimeMixer: Decomposable Multiscale Mixing for Time Series Forecasting. This package is compiled from the local SOTA survey metadata and source URL, and is intended to guide Lingxi10/Lingxi5 upgrade validation. It is not an official reproduction of the paper."
---
...
Primary Lingxi use: `Multiscale momentum/reversal/trend decomposition features`.

Datasets registered for comparison: ETTh1, ETTh2, ETTm1, ETTm2, Weather, Electricity, Traffic, Exchange Rate, PEMS.
