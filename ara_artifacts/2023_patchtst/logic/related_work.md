...
- **Type**: baseline
- **Delta**:
  - What changed: `PatchTST: A Time Series is Worth 64 Words` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `patch_transformer`.
- **Claims affected**: C02
