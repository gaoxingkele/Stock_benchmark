...
- **Statement**: `PatchTST: A Time Series is Worth 64 Words` is a relevant source for the local upgrade idea `Patch-token OHLCV feature proxy for Lingxi10/Lingxi5`.
- **Status**: hypothesis
