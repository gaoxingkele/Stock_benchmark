...
- **Statement**: `Unified Training of Universal Time Series Forecasting Transformers` is a relevant source for the local upgrade idea `Probabilistic any-variate representation candidate`.
- **Status**: hypothesis
