...
- **Type**: baseline
- **Delta**:
  - What changed: `Unified Training of Universal Time Series Forecasting Transformers` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `universal_forecasting_transformer`.
- **Claims affected**: C02
