...
doi: "https://arxiv.org/abs/2402.02592"
ara_version: "1.0"
domain: "cross-domain time-series methodology"
keywords: ["time-series", "universal-forecasting-transformer", "forecasting", "Lingxi-upgrade", "TopK-ranking", "ARA"]
claims_summary:
  - "Unified Training of Universal Time Series Forecasting Transformers contributes a universal_forecasting_transformer method family relevant to time-series modeling."
  - "The method is a candidate source for Probabilistic any-variate representation candidate."
abstract: "Methodology-focused ARA package for Unified Training of Universal Time Series Forecasting Transformers. This package is compiled from the local SOTA survey metadata and source URL, and is intended to guide Lingxi10/Lingxi5 upgrade validation. It is not an official reproduction of the paper."
---
...
Primary Lingxi use: `Probabilistic any-variate representation candidate`.

Datasets registered for comparison: M4, Monash Time Series Forecasting Archive.
