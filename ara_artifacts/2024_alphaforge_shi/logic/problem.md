...
- **Statement**: `2024_alphaforge_shi` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2024_alphaforge_shi.txt`
...
- **Statement**: `2024_alphaforge_shi` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
