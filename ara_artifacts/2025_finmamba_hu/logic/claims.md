...
- **Statement**: `2025_finmamba_hu` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2025_finmamba_hu` is grounded in current repository metadata and available source files.
- **Status**: supported
