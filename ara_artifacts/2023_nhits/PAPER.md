...
year: 2023
venue: "AAAI 2023"
doi: "https://ojs.aaai.org/index.php/AAAI/article/view/25854"
ara_version: "1.0"
domain: "cross-domain time-series methodology"
keywords: ["time-series", "hierarchical-interpolation", "forecasting", "Lingxi-upgrade", "TopK-ranking", "ARA"]
claims_summary:
  - "N-HiTS: Neural Hierarchical Interpolation for Time Series Forecasting contributes a hierarchical_interpolation method family relevant to time-series modeling."
  - "The method is a candidate source for Multi-rate sampling and interpolation-inspired features."
abstract: "Methodology-focused ARA package for N-HiTS: Neural Hierarchical Interpolation for Time Series Forecasting. This package is compiled from the local SOTA survey metadata and source URL, and is intended to guide Lingxi10/Lingxi5 upgrade validation. It is not an official reproduction of the paper."
---
...
Primary Lingxi use: `Multi-rate sampling and interpolation-inspired features`.

Datasets registered for comparison: M4.
