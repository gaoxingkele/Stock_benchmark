...
- **Implication**: N-HiTS: Neural Hierarchical Interpolation for Time Series Forecasting should be translated into a falsifiable proxy module before any production claim.

### O2: The paper belongs to the `hierarchical_interpolation` family
- **Statement**: Local survey metadata classifies this candidate as `hierarchical_interpolation`.
- **Evidence**: `papers/metadata/lingxi_cross_domain_ts_sota_candidates.csv`
- **Implication**: The first local validation should test the corresponding Lingxi transfer idea: `Multi-rate sampling and interpolation-inspired features`.
