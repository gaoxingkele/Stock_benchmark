...
- **Type**: baseline
- **Delta**:
  - What changed: `N-HiTS: Neural Hierarchical Interpolation for Time Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `hierarchical_interpolation`.
- **Claims affected**: C02
