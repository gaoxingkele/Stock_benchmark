...
- **Statement**: `2026_alphaprobe_guo` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2026_alphaprobe_guo` is grounded in current repository metadata and available source files.
- **Status**: supported
