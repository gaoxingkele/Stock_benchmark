...
- **Statement**: `2026_alphaprobe_guo` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2026_alphaprobe_guo.txt`
...
- **Statement**: `2026_alphaprobe_guo` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
