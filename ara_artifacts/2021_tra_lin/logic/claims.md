...
- **Statement**: `2021_tra_lin` is a valid local corpus paper for `stock trend/ranking prediction`.
- **Status**: supported
...
- **Statement**: Local project and/or source evidence has been bound into this ARA for `2021_tra_lin`.
- **Status**: supported
...
- **Statement**: `2021_tra_lin` independent local verification status is `complete`.
- **Status**: supported
