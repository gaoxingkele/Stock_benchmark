...
- **Setup**:
  ...
  - System: `Stock_benchmark/paper_projects/2021_tra_lin`
- **Procedure**:
...
## Local run bindings
  - tra_formal_h1: `experiments\paper_runs\tra_formal_csi300_2018_2024_h1.csv` with IC `-0.00552884` and RankIC `-0.02132450`
  - tra_formal_h5: `experiments\paper_runs\tra_formal_csi300_2018_2024_h5.csv` with IC `-0.01290636` and RankIC `-0.03135955`
