...
- **numeric_performance H1**: status=complete; IC=-0.00552884; RankIC=-0.02132450; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\tra_formal_csi300_2018_2024_h1.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
- **numeric_performance H5**: status=complete; IC=-0.01290636; RankIC=-0.03135955; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\tra_formal_csi300_2018_2024_h5.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
