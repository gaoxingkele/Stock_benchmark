...
- **Statement**: `2022_ddg_da_li` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2022_ddg_da_li` is grounded in current repository metadata and available source files.
- **Status**: supported
