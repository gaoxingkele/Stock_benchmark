...
- **Statement**: `2025_quantbench_wang` is included through `expansion_only`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2025_quantbench_wang.txt`
...
- **Statement**: `2025_quantbench_wang` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
