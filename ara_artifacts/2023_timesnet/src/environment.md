...
- Weather: not_downloaded (documented_only)
- Electricity: not_downloaded (documented_only)
- Traffic: not_downloaded (documented_only)
- Exchange Rate: not_downloaded (documented_only)
- ILI: not_downloaded (documented_only)
- PEMS: not_downloaded (documented_only)
