...
- **Statement**: `TimesNet: Temporal 2D-Variation Modeling for General Time Series Analysis` is a relevant source for the local upgrade idea `Periodic/multi-task feature inspiration for multiscale proxies`.
- **Status**: hypothesis
