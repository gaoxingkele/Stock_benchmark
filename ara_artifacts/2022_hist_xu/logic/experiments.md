...
- **Setup**:
  ...
  - System: `Stock_benchmark/paper_projects/2022_hist_xu`
- **Procedure**:
...
## Local run bindings
  - hist_formal_h1: `experiments\paper_runs\hist_formal_csi300_2018_2024_h1.csv` with IC `-0.00457830` and RankIC `-0.01433130`
  - hist_formal_h5: `experiments\paper_runs\hist_formal_csi300_2018_2024_h5.csv` with IC `-0.01629816` and RankIC `-0.03030684`
