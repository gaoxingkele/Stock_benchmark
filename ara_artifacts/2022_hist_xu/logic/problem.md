...
- **Statement**: `2022_hist_xu` is listed in the local paper registry with status `candidate_secondary`.
...
- **Statement**: A local PDF exists with `valid_pdf_header=True` and `1080885` bytes.
