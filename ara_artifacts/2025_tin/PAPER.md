...
ara_version: "1.0"
domain: "technical_indicator_network"
keywords:
  ...
  - ARA
claims_summary:
  - "2025_tin is represented as a complete local ARA package."
  - "Runnable proxy validation exists for China A-share, US large-cap, and HK large-cap under the H5 Top30 trading protocol."
abstract: "Not specified in provided sources. Local artifact compiled from repository metadata and validation results for Technical Indicator Networks: An Interpretable Neural Approach."
---

# Technical Indicator Networks: An Interpretable Neural Approach
