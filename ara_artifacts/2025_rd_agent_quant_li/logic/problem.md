...
- **Statement**: `2025_rd_agent_quant_li` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2025_rd_agent_quant_li.txt`
...
- **Statement**: `2025_rd_agent_quant_li` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
