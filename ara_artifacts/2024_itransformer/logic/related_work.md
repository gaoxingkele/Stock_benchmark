...
- **Type**: baseline
- **Delta**:
  - What changed: `iTransformer: Inverted Transformers Are Effective for Time Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `variate_attention`.
- **Claims affected**: C02
