...
- **Statement**: `iTransformer: Inverted Transformers Are Effective for Time Series Forecasting` is a relevant source for the local upgrade idea `Cross-sectional variate-attention ranking proxy`.
- **Status**: hypothesis
