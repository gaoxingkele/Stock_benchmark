...
- **Statement**: `Non-stationary Transformers: Exploring the Stationarity in Time Series Forecasting` is a relevant source for the local upgrade idea `Point-in-time normalization and de-stationary score restoration`.
- **Status**: hypothesis
