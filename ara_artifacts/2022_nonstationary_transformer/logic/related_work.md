...
- **Type**: baseline
- **Delta**:
  - What changed: `Non-stationary Transformers: Exploring the Stationarity in Time Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `nonstationarity_correction`.
- **Claims affected**: C02
