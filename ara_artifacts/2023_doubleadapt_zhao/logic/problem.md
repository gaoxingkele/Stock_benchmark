...
- **Statement**: `2023_doubleadapt_zhao` is listed in the local paper registry with status `candidate_verified`.
...
- **Statement**: A local PDF exists with `valid_pdf_header=True` and `1360567` bytes.
