...
- **Setup**:
  ...
  - System: `Stock_benchmark/paper_projects/2023_doubleadapt_zhao`
- **Procedure**:
...
## Local run bindings
  - doubleadapt_formal_h1: `experiments\paper_runs\doubleadapt_formal_csi300_2018_2024_h1.csv` with IC `0.00236500` and RankIC `-0.00312869`
  - doubleadapt_formal_h5: `experiments\paper_runs\doubleadapt_formal_csi300_2018_2024_h5.csv` with IC `0.06613830` and RankIC `0.05671244`
