...
- **numeric_performance H1**: status=complete; IC=0.00236500; RankIC=-0.00312869; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\doubleadapt_formal_csi300_2018_2024_h1.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
- **numeric_performance H5**: status=complete; IC=0.06613830; RankIC=0.05671244; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\doubleadapt_formal_csi300_2018_2024_h5.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
