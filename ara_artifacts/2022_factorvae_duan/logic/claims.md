...
- **Statement**: `2022_factorvae_duan` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2022_factorvae_duan` is grounded in current repository metadata and available source files.
- **Status**: supported
