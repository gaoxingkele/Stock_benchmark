...
keywords:
  ...
  - ARA
claims_summary:
  - "2025_alphaagent_tang is represented as a complete local ARA package."
  - "Runnable proxy validation exists for China A-share, US large-cap, and HK large-cap under the H5 Top30 trading protocol."
abstract: "Not specified in provided sources. Local artifact compiled from repository metadata and validation results for AlphaAgent: LLM-Driven Alpha Mining with Regularized Exploration to Counteract Alpha Decay."
---
