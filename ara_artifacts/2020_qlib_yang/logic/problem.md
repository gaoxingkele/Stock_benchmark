...
- **Statement**: `2020_qlib_yang` is included through `expansion_only`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2020_qlib_yang.txt`
...
- **Statement**: `2020_qlib_yang` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
