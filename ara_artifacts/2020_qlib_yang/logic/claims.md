...
- **Statement**: `2020_qlib_yang` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2020_qlib_yang` is grounded in current repository metadata and available source files.
- **Status**: supported
