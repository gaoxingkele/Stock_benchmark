...
- **Statement**: `Chronos: Learning the Language of Time Series` is a relevant source for the local upgrade idea `Probabilistic tokenized forecasting representation test`.
- **Status**: hypothesis
