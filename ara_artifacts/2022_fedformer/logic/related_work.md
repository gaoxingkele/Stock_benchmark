...
- **Type**: baseline
- **Delta**:
  - What changed: `FEDformer: Frequency Enhanced Decomposed Transformer for Long-term Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `frequency_decomposition`.
- **Claims affected**: C02
