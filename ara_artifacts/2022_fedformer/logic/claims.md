...
- **Statement**: `FEDformer: Frequency Enhanced Decomposed Transformer for Long-term Series Forecasting` is a relevant source for the local upgrade idea `Frequency/seasonal-trend features for multiscale proxy`.
- **Status**: hypothesis
