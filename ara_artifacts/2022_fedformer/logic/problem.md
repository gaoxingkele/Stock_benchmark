...
- **Implication**: FEDformer: Frequency Enhanced Decomposed Transformer for Long-term Series Forecasting should be translated into a falsifiable proxy module before any production claim.

### O2: The paper belongs to the `frequency_decomposition` family
- **Statement**: Local survey metadata classifies this candidate as `frequency_decomposition`.
- **Evidence**: `papers/metadata/lingxi_cross_domain_ts_sota_candidates.csv`
- **Implication**: The first local validation should test the corresponding Lingxi transfer idea: `Frequency/seasonal-trend features for multiscale proxy`.
