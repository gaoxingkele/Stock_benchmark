...
- **Statement**: `2024_lsr_igru_zhu` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2024_lsr_igru_zhu` is grounded in current repository metadata and available source files.
- **Status**: supported
