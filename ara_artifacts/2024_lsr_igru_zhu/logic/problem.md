...
- **Statement**: `2024_lsr_igru_zhu` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2024_lsr_igru_zhu.txt`
...
- **Statement**: `2024_lsr_igru_zhu` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
