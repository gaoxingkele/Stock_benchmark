...
- **Statement**: `2024_diffsformer_gao` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2024_diffsformer_gao.txt`
...
- **Statement**: `2024_diffsformer_gao` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
