...
- **Statement**: `2024_mdgnn_li` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2024_mdgnn_li` is grounded in current repository metadata and available source files.
- **Status**: supported
