...
- **Type**: baseline
- **Delta**:
  - What changed: `Are Transformers Effective for Time Series Forecasting?` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `decomposition_linear`.
- **Claims affected**: C02
