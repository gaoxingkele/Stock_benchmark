...
- **Statement**: `Are Transformers Effective for Time Series Forecasting?` is a relevant source for the local upgrade idea `LinearGuard baseline every neural upgrade must beat`.
- **Status**: hypothesis
