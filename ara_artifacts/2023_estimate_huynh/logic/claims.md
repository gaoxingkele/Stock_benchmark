...
- **Statement**: `2023_estimate_huynh` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2023_estimate_huynh` is grounded in current repository metadata and available source files.
- **Status**: supported
