...
- **numeric_performance H1**: status=complete; IC=-0.00719981; RankIC=-0.01291857; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\tcts_formal_csi300_2018_2024_h1.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
- **numeric_performance H5**: status=complete; IC=-0.00876161; RankIC=-0.01981910; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\tcts_formal_csi300_2018_2024_h5.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
