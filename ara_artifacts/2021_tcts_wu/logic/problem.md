...
- **Statement**: `2021_tcts_wu` is listed in the local paper registry with status `candidate_expanded`.
...
- **Statement**: A local PDF exists with `valid_pdf_header=True` and `900989` bytes.
