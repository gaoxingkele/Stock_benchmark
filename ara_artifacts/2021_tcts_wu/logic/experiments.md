...
- **Setup**:
  ...
  - System: `Stock_benchmark/paper_projects/2021_tcts_wu`
- **Procedure**:
...
## Local run bindings
  - tcts_formal_h1: `experiments\paper_runs\tcts_formal_csi300_2018_2024_h1.csv` with IC `-0.00719981` and RankIC `-0.01291857`
  - tcts_formal_h5: `experiments\paper_runs\tcts_formal_csi300_2018_2024_h5.csv` with IC `-0.00876161` and RankIC `-0.01981910`
