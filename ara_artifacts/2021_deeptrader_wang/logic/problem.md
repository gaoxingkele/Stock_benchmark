...
- **Statement**: `2021_deeptrader_wang` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2021_deeptrader_wang.txt`
...
- **Statement**: `2021_deeptrader_wang` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
