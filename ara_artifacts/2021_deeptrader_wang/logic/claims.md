...
- **Statement**: `2021_deeptrader_wang` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2021_deeptrader_wang` is grounded in current repository metadata and available source files.
- **Status**: supported
