...
year: 2024
venue: "NeurIPS 2024"
doi: "https://openreview.net/forum?id=3O5YCEWETq"
ara_version: "1.0"
domain: "cross-domain time-series methodology"
keywords: ["time-series", "tiny-pretrained-ts-model", "forecasting", "Lingxi-upgrade", "TopK-ranking", "ARA"]
claims_summary:
  - "Tiny Time Mixers for Long-term Multivariate Time Series Forecasting contributes a tiny_pretrained_ts_model method family relevant to time-series modeling."
  - "The method is a candidate source for Lightweight pretrained baseline/feature candidate."
abstract: "Methodology-focused ARA package for Tiny Time Mixers for Long-term Multivariate Time Series Forecasting. This package is compiled from the local SOTA survey metadata and source URL, and is intended to guide Lingxi10/Lingxi5 upgrade validation. It is not an official reproduction of the paper."
---

# Tiny Time Mixers for Long-term Multivariate Time Series Forecasting
...
Primary Lingxi use: `Lightweight pretrained baseline/feature candidate`.

Datasets registered for comparison: Monash Time Series Forecasting Archive.
