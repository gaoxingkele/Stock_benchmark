...
- **Type**: baseline
- **Delta**:
  - What changed: `Tiny Time Mixers for Long-term Multivariate Time Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `tiny_pretrained_ts_model`.
- **Claims affected**: C02
