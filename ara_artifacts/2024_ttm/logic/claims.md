...
- **Statement**: `Tiny Time Mixers for Long-term Multivariate Time Series Forecasting` is a relevant source for the local upgrade idea `Lightweight pretrained baseline/feature candidate`.
- **Status**: hypothesis
