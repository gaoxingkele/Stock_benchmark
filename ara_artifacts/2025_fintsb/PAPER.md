...
ara_version: "1.0"
domain: "financial_time_series_benchmark"
keywords:
  ...
  - ARA
claims_summary:
  - "2025_fintsb is represented as a complete local ARA package."
  - "Runnable proxy validation exists for China A-share, US large-cap, and HK large-cap under the H5 Top30 trading protocol."
abstract: "Not specified in provided sources. Local artifact compiled from repository metadata and validation results for FinTSB: A Comprehensive and Practical Benchmark for Financial Time Series."
---

# FinTSB: A Comprehensive and Practical Benchmark for Financial Time Series
