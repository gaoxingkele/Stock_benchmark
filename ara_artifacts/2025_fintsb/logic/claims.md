...
- **Statement**: `2025_fintsb` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2025_fintsb` is grounded in current repository metadata and available source files.
- **Status**: supported
