...
- **numeric_performance H1**: status=complete; IC=-0.01077460; RankIC=-0.02718109; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\adarnn_formal_csi300_2018_2024_h1.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
- **numeric_performance H5**: status=complete; IC=-0.02084717; RankIC=-0.04531338; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\adarnn_formal_csi300_2018_2024_h5.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
