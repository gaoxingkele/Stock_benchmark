...
- **Statement**: `2021_adarnn_du` is listed in the local paper registry with status `candidate_expanded`.
...
- **Statement**: A local PDF exists with `valid_pdf_header=True` and `1295311` bytes.
