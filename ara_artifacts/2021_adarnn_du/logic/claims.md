...
- **Statement**: `2021_adarnn_du` is a valid local corpus paper for `time series forecasting / financial analysis`.
- **Status**: supported
...
- **Statement**: Local project and/or source evidence has been bound into this ARA for `2021_adarnn_du`.
- **Status**: hypothesis
...
- **Statement**: `2021_adarnn_du` independent local verification status is `complete`.
- **Status**: supported
