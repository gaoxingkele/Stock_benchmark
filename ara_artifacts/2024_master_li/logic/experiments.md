...
- **Setup**:
  ...
  - System: `Stock_benchmark/paper_projects/2024_master_li`
- **Procedure**:
...
## Local run bindings
  - master_formal_h1: `experiments\paper_runs\master_formal_csi300_2018_2024_h1.csv` with IC `-0.00173863` and RankIC `-0.01482999`
  - master_formal_h5: `experiments\paper_runs\master_formal_csi300_2018_2024_h5.csv` with IC `-0.01162947` and RankIC `-0.01968499`
