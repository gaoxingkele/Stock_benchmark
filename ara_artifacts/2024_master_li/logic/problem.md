...
- **Statement**: `2024_master_li` is listed in the local paper registry with status `candidate_verified`.
...
- **Statement**: A local PDF exists with `valid_pdf_header=True` and `451322` bytes.
