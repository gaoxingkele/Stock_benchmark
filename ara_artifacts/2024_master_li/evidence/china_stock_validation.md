...
- **numeric_performance H1**: status=complete; IC=-0.00173863; RankIC=-0.01482999; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\master_formal_csi300_2018_2024_h1.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
- **numeric_performance H5**: status=complete; IC=-0.01162947; RankIC=-0.01968499; source=`C:\aicoding\Stock_benchmark\experiments\paper_runs\master_formal_csi300_2018_2024_h5.csv`; reason=Paper-inspired model emits stock-level predictions evaluated by daily IC/RankIC.
