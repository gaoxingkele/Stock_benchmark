...
- **Statement**: `2024_ci_sthpan_xia` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2024_ci_sthpan_xia` is grounded in current repository metadata and available source files.
- **Status**: supported
