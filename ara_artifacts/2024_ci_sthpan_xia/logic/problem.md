...
- **Statement**: `2024_ci_sthpan_xia` is included through `paper_24_matrix`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2024_ci_sthpan_xia.txt`
...
- **Statement**: `2024_ci_sthpan_xia` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
