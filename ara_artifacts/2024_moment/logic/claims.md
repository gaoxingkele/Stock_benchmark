...
- **Statement**: `MOMENT: A Family of Open Time-series Foundation Models` is a relevant source for the local upgrade idea `General TS representation candidate across tasks`.
- **Status**: hypothesis
