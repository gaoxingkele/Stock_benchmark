...
- **Type**: baseline
- **Delta**:
  - What changed: `MOMENT: A Family of Open Time-series Foundation Models` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `foundation_model_multitask`.
- **Claims affected**: C02
