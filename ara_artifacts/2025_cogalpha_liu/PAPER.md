...
ara_version: "1.0"
domain: "code_based_alpha_generation"
keywords:
  ...
  - ARA
claims_summary:
  - "2025_cogalpha_liu is represented as a complete local ARA package."
  - "Runnable proxy validation exists for China A-share, US large-cap, and HK large-cap under the H5 Top30 trading protocol."
abstract: "Not specified in provided sources. Local artifact compiled from repository metadata and validation results for Cognitive Alpha Mining via LLM-Driven Code-Based Evolution."
---
