...
- **Statement**: `2025_cogalpha_liu` is included through `expansion_only`.
...
- **Evidence**: `papers/metadata/pdf_download_status.csv`, `papers/extracted/2025_cogalpha_liu.txt`
...
- **Statement**: `2025_cogalpha_liu` did not have a complete ARA directory before this generated package.
- **Caused by**: O1
