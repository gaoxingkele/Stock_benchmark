...
- **Statement**: `2025_cogalpha_liu` has the mandatory ARA layers and core files.
- **Status**: supported
...
- **Statement**: `2025_cogalpha_liu` is grounded in current repository metadata and available source files.
- **Status**: supported
