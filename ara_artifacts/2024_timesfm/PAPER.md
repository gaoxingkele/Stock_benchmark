...
doi: "https://research.google/blog/a-decoder-only-foundation-model-for-time-series-forecasting/"
ara_version: "1.0"
domain: "cross-domain time-series methodology"
keywords: ["time-series", "foundation-forecaster", "forecasting", "Lingxi-upgrade", "TopK-ranking", "ARA"]
claims_summary:
  - "A Decoder-Only Foundation Model for Time-Series Forecasting contributes a foundation_forecaster method family relevant to time-series modeling."
  - "The method is a candidate source for Later-stage foundation-model feature source."
abstract: "Methodology-focused ARA package for A Decoder-Only Foundation Model for Time-Series Forecasting. This package is compiled from the local SOTA survey metadata and source URL, and is intended to guide Lingxi10/Lingxi5 upgrade validation. It is not an official reproduction of the paper."
---
...
Primary Lingxi use: `Later-stage foundation-model feature source`.

Datasets registered for comparison: Not specified in provided sources.
