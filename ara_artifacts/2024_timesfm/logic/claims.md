...
- **Statement**: `A Decoder-Only Foundation Model for Time-Series Forecasting` is a relevant source for the local upgrade idea `Later-stage foundation-model feature source`.
- **Status**: hypothesis
