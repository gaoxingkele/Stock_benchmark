...
- **Type**: baseline
- **Delta**:
  - What changed: `A Decoder-Only Foundation Model for Time-Series Forecasting` is added as cross-domain time-series methodology, not finance-specific prior art.
...
- **Delta**:
  ...
  - Why: It motivates gated, module-level validation for `foundation_forecaster`.
- **Claims affected**: C02
